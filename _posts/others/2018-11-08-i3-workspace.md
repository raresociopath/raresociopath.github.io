...
i3 workspace manager ( i3wm)

# Why i3?
For more than 7 years i've been using this very light workspace manager that worked just perfect for everything I needed.

**Before using i3**
You should realize the follow:
* You love shortcuts.
* You can do everything without using the mouse.
* You love multiple windows on the same screen.
